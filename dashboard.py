...
app.layout = html.Div([
                    ...
                    dbc.Row(
                        dbc.Col([
                            ...
                            html.Span(dcc.Link('Liferando.de. ', href='https://www.lieferando.de/'), style={"font-style": "italic", "font-size": 14, "color": "grey"}),
                            ...
                            html.Span(dcc.Link('Selenium ', href='https://selenium-python.readthedocs.io/'), style={"font-style": "italic", "font-size": 14, "color": "grey"}),
                            html.Span("& ", style={"font-style": "italic", "font-size": 14, "color": "grey"}),
                            html.Span(dcc.Link('Dash ', href='https://dash.plotly.com/'), style={"font-style": "italic", "font-size": 14, "color": "grey"}),
                            html.Span("libraries by Tomas Kristof sometimes in October 2020.", style={"font-style": "italic", "font-size": 14, "color": "grey"}),
                            html.Br(),
                            html.Br(),
                            html.Span(dcc.Link('GitHub', href='https://github.com/kristoftomas'), style={"font-size": 14, "color": "gray"}),
                            html.Span(" | ", style={"font-size": 14, "color": "gray"}),
                            html.Span(dcc.Link(' LinkedIn', href='https://www.linkedin.com/in/kristoftomas/'), style={"font-size": 14, "color": "grey"}),
                            html.Br(),
                            html.Br(),
